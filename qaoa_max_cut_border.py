...
for n_nodes in range(10, 11):
    ...
    while i < test:
        ...
        if exact_value != expected_value_one_state:
            ...
            path_data = (
                f"logger_data/logger_data_qaoa_performance_gibbs_states/logger_data_qaoa_performance_gibbs_states_borders/logger_data_max_cut_qaoa_common_instances_n_{n_nodes}_borders/"
