...
test = 30
pb_conexion = 0.7
temperatures = [0.5, 1, 2, 3, 4, 5, 6, 7, 8]
n_layers_list = [3, 5]
    ...
    for z in range(len(n_layers_list)):
        ...
        for n_nodes in range(16, 15, -1):
            ...
            while i < test:
                ...
                path_data = (
                    f"logger_data/logger_data_qaoa_performance_gibbs_states/logger_data_qaoa_performance_gibbs_states_borders_hadamard_state/logger_data_max_cut_qaoa_common_instances_n_{n_nodes}_borders/"
